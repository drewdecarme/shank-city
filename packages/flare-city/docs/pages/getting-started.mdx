...
For more information on the `App` class, [check out the `App` documentation](./reference/app.md)
...
For more information on the `Middleware` type, [check out the `Middleware` documentation](./reference/middleware.md)

### Define & add any routes

Routes define the API endpoints and their corresponding handlers.

For more information on the `Route` class, [check out the `Route` documentation](./reference/route.md)
...
The `run` method executes the app logic, including middleware and route handling.
